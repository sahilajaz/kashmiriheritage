...
const Contact = () => {
  ...
  return (
    <section className='mt-16 sm:mt-10 w-full lg:mb-96 sm:mb-96 mb-[500px]'>
      <div className="w-full relative">
        <div className='bg-slate-700 w-full h-[30vw] flex flex-col justify-center items-center'>
          <h1 className='text-center text-sm sm:text-4xl mt-2 sm:mt-0 font-extrabold text-white'>Contact Us</h1>
          <p className='text-center text-sm sm:text-1xl  mb-8 lg:mb-0 text-white'>Questions, feedback—we're here for it all</p>
        </div>
