                ...
                <Carousel>
                    {carouselData.map((item) => (
                        <div key={item.id} className='w-full h-[60vh] sm:h-[900px]'>
                            <div className="hidden sm:block absolute inset-0 bg-black/30"></div>
                            <img src={item.pic} alt={`Carousel image ${item.id}`} className='w-[1000vh] sm:w-screen h-[60vh] sm:h-[900px] mt-9 sm:mt-0' />
                        </div>
                    ))}
                </Carousel>
            </div>
